...
const PATTERNS = [
  ...
  { re: /공공기관/g, label: '공공기관 특화(branding/public-lecture·audience-profiles·예시 맥락은 예외)', exceptIn: /(branding[\\\/]public-lecture|audience-profiles\.md|human-in-loop\.md|expert-council\.md)/ },
